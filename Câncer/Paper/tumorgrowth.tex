...
Ainda no trabalho de \cite{Enderling2014}, foi apresentada uma abordagem simples e direta para a inclusão de tratamento por quimioterapia nas equações de crescimento.

% Falar sobre o coeficiente de quimioterapia (Enderling 2014)
% Gancho: modelo de tratamento de Panetta 1996
% Competição (Panetta 1996)
