...
\includegraphics{noChemoCompet}

Testes adicionado quimioterapia e competição também foram realizados, trazendo resultados discrepantes na quantia de células em função do tempo. Os parâmetros utilizados foram os mesmos, diferindo apenas no \lambda1 = 0.00003, \lambda2 = 0.0000002, dose = 0.2 e período da dose = 2.

\includegraphics{chemoCompet}
