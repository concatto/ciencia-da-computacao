...
%1modelo do cancer
O processo de modelagem dos modelos matemáticos do câncer é extremamente complexo que envolve o conhecimento de diferentes áreas de conhecimento, tanto biôlogicos, medicinais, matemáticos e etc.
...
% Modelo de Panetta
%FAZER A CITAÇÃO NO X kkk
Estudos feitos por (X) avaliam os resultados da influencia de fibroblastos dermicos normais nas celulas de melanomas de humanos obtidas em diferentes estágios do progresso do tumor. Foi descoberto, por experimentos em vitro, que a maioria de linhas de melanomas derivadas do inicio do estagio da fase de crescimento radial ou metaestático são reprimidas por fibroblastos dermicos normais, insinuando que o cresimento homeostático negativo ainda estão operantes nas celulas melanomas dos estagios iniciais da doença. Entretanto, cerca de 80\% da celulas melanomas derivada da metastase já avançada, foram estimadas o crescimento consistente para crescerem na presença de fibroblastos dermicos. Logo, o conjuntos de resultados obtidos indicam que fibroblastos poder tem efeitos de crescimento antieticos e inesperados em tumores.
